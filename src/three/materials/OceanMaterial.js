...
const normalMap1 = new Uniform(new TextureLoader().load("./src/assets/images/waterNormal1.png"));
...
const objectTexture = new TextureLoader().load("./src/assets/images/basicChecker.png");
objectTexture.wrapS = RepeatWrapping;
objectTexture.wrapT = RepeatWrapping;

const landTexture = new TextureLoader().load("./src/assets/images/sand.png");
