<template>
  <div class="p-6">
    <div class="text-slate-300 text-center">
      数据总量：
      <span ref="totalCountTargrt" class="text-gradient font-[Electronic] text-7xl ml-2 mr-2 font-bold">
        679,473,929
      </span>
      条记录
    </div>
...
const totalCountTargrt = ref(null)
...
onMounted(() => {
  new CountUp(totalCountTargrt.value, props.data.total).start()
